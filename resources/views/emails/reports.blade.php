...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"
  ...
  <head>
    ...
    <title>Report card for {{ currentTerm() }}</title>
    <!--[if (mso 16)]>
				<style type="text/css">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center"
              ...
              <tr style="border-collapse:collapse">
                <td cellpadding="0" cellspacing="0" border="0"
                  ...
                  <img src="https://portal.acce-kano.ng/img/accekano.png"
                                ...
                                <tr style="border-collapse:collapse">
                                  <td align="center" style="padding:0;Margin:0;padding-bottom:25px;padding-top:40px">
                                    <p
                                      ...
                                      <strong>{{ config('app.name', 'Al-Ansar Centre for Comprehensive Education, Kano') }}</strong>
                                    </p>
                                  </td>
                                </tr>
                              </table>
                              ...
                              <table
                                ...
                                <tr style="border-collapse:collapse">
                                  <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img"
                                      src="https://portal.acce-kano.ng/img/accekano.png" alt
                                ...
                                <tr style="border-collapse:collapse">
                                  <td align="center"
                                    ...
                                    <h1
                                      style="text-transform:capitalize;:0;line-height:38px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:25px;font-style:normal;font-weight:medium;color:#111111">
                                      {{ greeting()}}, {{ $guardian->first_name . ' ' . $guardian->last_name }}
                                    </h1>
                                  </td>
                                </tr>
                                <tr style="border-collapse:collapse">
                              ...
                              <table
                                ...
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                    ...
                                    <p
                                      ...
                                      We're excited to tell you the report card of your
                                      {{ $guardian->students->count() > 1 ? 'children' : 'child' }} at
                                      {{ env('APP_NAME')}} <span
                                        style="color:#d04; font-size: 15px">{{ strtoupper(currentTerm())}}</span> is
                                      ready. You can view and download them by clicking on the following links.
                                    <ol>
                                      @foreach ($guardian->students as $child)
                                      <li style="text-transform:capitalize; padding:8px;">
                                        {{ $child->first_name . '  '. $child->last_name }} <span>
                                          <a href="{{ url('/reportcard/' . latestTerm()->id .'/'.$child->id) }}"
                                            class="es-button es-button-1" target="_blank"
                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;border-style:solid; padding: 2px 10px; text-transform:capitalize ;background:#2a7;border-radius:45px;font-family:verdana, geneva, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center">
                                            Download here</a>
                                        </span>
                                      </li>
                                      @endforeach
                                ...
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-l" align="left"
                                    ...
                                    <p
                                      style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                      If you have any questions, just reply to this email or info@acce-kano.ng. we're
